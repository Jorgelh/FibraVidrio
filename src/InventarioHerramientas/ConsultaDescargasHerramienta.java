 ...
 * @author jluis
 */
public class ConsultaDescargasHerramienta extends javax.swing.JInternalFrame {

    /**
     * Creates new form ConsultaDescargasMat
     */
    public ConsultaDescargasHerramienta() {
        initComponents();
        ListaDescargas();
    }
    ...
    private void ListaDescargas() {
        ArrayList<nuevo> result = NuevoProducto.HerramientaDescargada(descripcion.getText());
    ...
    public void recargarTablaPro(ArrayList<nuevo> list) {
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
                datos,
                new String[]{
                    "DESCRIPCION","FECHA","CANTIDAD","NOTA"
                }) {
                     @Override
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaDescargasHerramienta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaDescargasHerramienta().setVisible(true);
            }
        });
    }
