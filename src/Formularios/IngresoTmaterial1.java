 ...
 * @author jluis
 */
public class IngresoTmaterial1 extends javax.swing.JInternalFrame {
    ...
    /*public void obtenerUltimoIdfam() {
        try {
            ...
            ResultSet rs = stmt.executeQuery("select max(NO_TIPO) from M_MATERIAL");
            while (rs.next()) {
    ...
    */
    ...
    private void jtFMedidaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtFMedidaMouseClicked
        ...
        BFguardar.setEnabled(false);
        try {
            DescripcionC m = EditComponentesHerramienta.buscarMaterial(Integer.parseInt(String.valueOf(jtFMedida.getModel().getValueAt(jtFMedida.getSelectedRow(),0))));
    ...
    private void BFguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BFguardarActionPerformed
        ...
        if(accion.equalsIgnoreCase("Guardar")){
            ...
            if (txtId.getText().compareTo("")!=0 && txtFDescripcion.getText().compareTo("")!=0){
                try {
                    ...
                    EditComponentesHerramienta.insertarMaterial(m);
        ...
        if (accion.equalsIgnoreCase("Actualizar")) {
            DescripcionC p;
            try {
                p=EditComponentesHerramienta.buscarMaterial(Integer.parseInt(txtId.getText()));
     ...
     */
       ...
       try {
            ...
            java.util.logging.Logger.getLogger(IngresoTmaterial1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
       ...
       // </editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IngresoTmaterial1().setVisible(true);
            }
        });
}
