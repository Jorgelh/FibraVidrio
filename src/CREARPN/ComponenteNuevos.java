 ...
 * @author jluis
 */
public class ComponenteNuevos extends javax.swing.JInternalFrame {
    int nodescri;
    int pin;
    int num;
    int inserto;
    ...
    public void guardar(){
     ...
     private void BusquedaComponentes(){
        ArrayList<DescripcionC> result = DBDescripcion.ListarComponentesNombre(Descrip.getText());
    ...
    public void recargarTable(ArrayList<DescripcionC> list) {
        ...
        {
            datos[i][0] = f.getDescripcion();
       
            i++;
        }
        Decri.setModel(new javax.swing.table.DefaultTableModel(
                datos,
                new String[]{
                    "DESCRIPCION"
                }) {
        ...
        TableColumn columna1 = Decri.getColumn("DESCRIPCION");
    ...
    private void initComponents() {
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "CONSULTA DE PARTES", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N

        Descrip.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jScrollPane1.setViewportView(Decri);
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "NUEVA PARTE", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComponenteNuevos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ComponenteNuevos().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable Decri;
