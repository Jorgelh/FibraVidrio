 ...
 * @author jluis
 */
public class ConsultaTrabajos extends javax.swing.JInternalFrame {
    ...
    private void TablaJob() {
        ...
        ArrayList<CTrabajos>result = Trabajos.ListarJobTodo();
        cargarTabla(result);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaTrabajos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaTrabajos().setVisible(true);
            }
        });
    }
